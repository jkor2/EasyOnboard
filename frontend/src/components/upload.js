      ...
      >
        ...
        <Container>
          <Form
            className="mt-3"
            method="POST"
            onSubmit={handleIndividualUpload}
          >
            <Form.Group
              as={Row}
            ...
            <Form.Group as={Row} className="mb-3 form-control-sm">
              <Col>
                <Button type="submit" className="btn-lg width-50 bg-custom-css">
                  Add Employee to DB
                </Button>
              </Col>
            </Form.Group>
        ...
        <Container className="mt-3">
          <Alert show={show} variant="info" className="custom-alert">
            ...
            <ol>
              <li>
                Download CSV template by clicking the gray "Download CSV button"
              </li>
              <li>Take a look at the default values pre-populated</li>
              <li>Remove those and replace with your data</li>
              <li>
                Ensure there are no special characters using "Find and Replace"
              </li>
              <li>
                Match the Boolean columns to your employee/applicant status
              </li>
              <li>
                Scroll to the bottom of the page and select the green upload
                button
              </li>
            </ol>
        ...
        <Container>
          <Button variant="secondary btn-sm" onClick={downloadTeamplateCSV}>
            Download CSV Teamplate
          </Button>{" "}
        </Container>
        ...
        {csvUploadData ? (
          <Container fluid>
            ...
            <Container className=" mt-3 d-flex w-100 gap-5 justify-content-center">
              <Button variant="danger  btn-lg" onClick={handleUplaodCancel}>
                Cancel Upload
              </Button>{" "}
