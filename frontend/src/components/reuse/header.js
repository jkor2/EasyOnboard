...
function Header() {
  ...
  return (
   <>
<Navbar key={"sm"} expand={"sm"} className="text-light bg-custom-css mb-3">
  <Container fluid className="text-light">
    <Navbar.Brand href="#" className="text-light">EzOnboard</Navbar.Brand>
    <Navbar.Toggle aria-controls={`offcanvasNavbarDropdown-expand-sm`} className="text-light"/>
    <Navbar.Offcanvas
    ...
    >
      <Offcanvas.Header closeButton className="text-light bg-custom-css">
        <Offcanvas.Title id={`offcanvasNavbarDropdown-expand-sm text-light`}>
          Offcanvas
        </Offcanvas.Title>
      </Offcanvas.Header>
